...
function QuoteStudio(){
  ...
  const exportVideo=async(presetOverride=null,fpsOverride=null)=>{
    ...
    try{
      ...
      const stream=canvas.captureStream(selectedFps);const chunks=[];const mime=MediaRecorder.isTypeSupported('video/webm;codecs=vp9,opus')?'video/webm;codecs=vp9,opus':'video/webm';
      ...
      setExportStatus({phase:`Rendering ${profile.label} at ${selectedFps} FPS with soundtrack…`,pct:5});
