...
export default function RhymeGenerator() {
  ...
  return <div className="rg-shell">
    ...
    <div className="rg-wrap">
      <div className="rg-head"><div className="rg-title"><h1>🎵 Kids Rhyme Generator</h1><p>Paste your exact lyrics. The module will use only those words—nothing will be added.</p></div><div className="rg-badge">Q8 HIGH QUALITY · {selectedDuration} SEC</div></div>
